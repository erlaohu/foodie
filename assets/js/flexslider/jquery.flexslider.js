  ...
  $.flexslider = function(el, options) {
    ...
    slider.init = function() {
      ...
      if (slider.vars.directionNav) {
        var directionNavScaffold = $('<ul class="flex-direction-nav"><li><a class="prev" href="javascript:void(0)">' + slider.vars.prevText + '</a></li><li><a class="next" href="javascript:void(0)">' + slider.vars.nextText + '</a></li></ul>');
